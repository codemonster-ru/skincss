export default {
    ...
    'bg-amber-950': {
        backgroundColor: 'var(--color-amber-950)',
    },
    'bg-yellow-50': {
    ...
    'bg-lime-950': {
        backgroundColor: 'var(--color-lime-950)',
    },
    'bg-green-50': {
    ...
    'bg-emerald-300': {
        backgroundColor: 'var(--color-emerald-300)',
    },
    'bg-emerald-400': {
    ...
    'bg-cyan-950': {
        backgroundColor: 'var(--color-cyan-950)',
    },
    'bg-sky-50': {
        backgroundColor: 'var(--color-sky-50)',
    },
    'bg-sky-100': {
    ...
    'bg-sky-700': {
        backgroundColor: 'var(--color-sky-700)',
    },
    'bg-sky-800': {
        backgroundColor: 'var(--color-sky-800)',
    },
    'bg-sky-900': {
        backgroundColor: 'var(--color-sky-900)',
    },
    'bg-sky-950': {
    ...
    'bg-violet-300': {
        backgroundColor: 'var(--color-violet-300)',
    },
    'bg-violet-400': {
    ...
    'bg-violet-700': {
        backgroundColor: 'var(--color-violet-700)',
    },
    'bg-violet-800': {
    ...
    'bg-purple-950': {
        backgroundColor: 'var(--color-purple-950)',
    },
    'bg-fuchsia-50': {
        backgroundColor: 'var(--color-fuchsia-50)',
    },
    'bg-fuchsia-100': {
        backgroundColor: 'var(--color-fuchsia-100)',
    },
    'bg-fuchsia-200': {
    ...
    'bg-fuchsia-500': {
        backgroundColor: 'var(--color-fuchsia-500)',
    },
    'bg-fuchsia-600': {
    ...
    'bg-fuchsia-900': {
        backgroundColor: 'var(--color-fuchsia-900)',
    },
    'bg-fuchsia-950': {
        backgroundColor: 'var(--color-fuchsia-950)',
    },
    'bg-pink-50': {
    ...
    'bg-pink-950': {
        backgroundColor: 'var(--color-pink-950)',
    },
    'bg-rose-50': {
    ...
    'bg-rose-800': {
        backgroundColor: 'var(--color-rose-800)',
    },
    'bg-rose-900': {
        backgroundColor: 'var(--color-rose-900)',
    },
    'bg-rose-950': {
        backgroundColor: 'var(--color-rose-950)',
    },
    'bg-slate-50': {
    ...
    'bg-stone-300': {
        backgroundColor: 'var(--color-stone-300)',
    },
    'bg-stone-400': {
        backgroundColor: 'var(--color-stone-400)',
    },
    'bg-stone-500': {
        backgroundColor: 'var(--color-stone-500)',
    },
    'bg-stone-600': {
        backgroundColor: 'var(--color-stone-600)',
    },
    'bg-stone-700': {
