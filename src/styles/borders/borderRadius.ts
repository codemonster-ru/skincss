export default {
    ...
    'rounded-s-4xl': {
        borderStartStartRadius: 'var(--radius-4xl)',
        borderEndStartRadius: 'var(--radius-4xl)',
    },
    'rounded-s-none': {
    ...
    'rounded-e-4xl': {
        borderStartEndRadius: 'var(--radius-4xl)',
        borderEndEndRadius: 'var(--radius-4xl)',
    },
    'rounded-e-none': {
    ...
    'rounded-t-4xl': {
        borderTopLeftRadius: 'var(--radius-4xl)',
        borderTopRightRadius: 'var(--radius-4xl)',
    },
    'rounded-t-none': {
    ...
    'rounded-r-4xl': {
        borderTopRightRadius: 'var(--radius-4xl)',
        borderBottomRightRadius: 'var(--radius-4xl)',
    },
    'rounded-r-none': {
        borderTopRightRadius: '0',
    ...
    'rounded-b-4xl': {
        borderBottomRightRadius: 'var(--radius-4xl)',
        borderBottomLeftRadius: 'var(--radius-4xl)',
    },
    'rounded-b-none': {
        borderBottomRightRadius: '0',
